                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div>
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-budget-header hover:bg-budget-header/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-budget-header transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-sans"
                        >
